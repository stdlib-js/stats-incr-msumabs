...
tape( 'main export is a function', function test( t ) {
	...
	t.strictEqual( typeof incrmsumabs, 'function', 'main export is a function' );
	t.end();
});
...
tape( 'the function returns an accumulator function', function test( t ) {
	t.equal( typeof incrmsumabs( 3 ), 'function', 'returns a function' );
	t.end();
});
